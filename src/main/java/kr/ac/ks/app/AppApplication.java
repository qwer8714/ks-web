...
public class AppApplication {
	...
	public CommandLineRunner runner(StudentRepository studentRepository,
		...
		return (args) -> {
			...
			lessonRepository.save(Lesson.builder().name("L1").quota(15).remainingQuota(15).build());
			lessonRepository.save(Lesson.builder().name("L2").quota(15).remainingQuota(15).build());
			lessonRepository.save(Lesson.builder().name("L3").quota(1).remainingQuota(1).build());
		};
	}
